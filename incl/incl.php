...
define('MIN_ITEM_LEVEL_PRICING', 15); // items with an item level below this amount, after bonuses are applied, will be considered as the base item level for pricing
